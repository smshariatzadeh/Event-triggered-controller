...
%
% a class for solving finite Optimal Control for  constrained linear system
% used MPT3
    ...
    properties (SetAccess = private)
        ...
        Ak %: A + BK closed loop dynamics with LQR feedback
    ...
    methods (Access = public)
        ...
        function obj = OptimalControler(sys, Q, R, Xc, Uc, N)
            obj.sys = sys;
            obj.Q = Q;
            obj.R = R;
            obj.Xc = Xc;
            ...
            obj.Uc = Uc;
            obj.N = N;
            [K_tmp, obj.P] = dlqr(obj.sys.A, obj.sys.B, obj.Q, obj.R);
            obj.K = -K_tmp;
            obj.Ak = (obj.sys.A+obj.sys.B*obj.K);
